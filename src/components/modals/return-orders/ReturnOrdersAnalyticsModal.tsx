...
export function ReturnOrdersAnalyticsModal({ open, onOpenChange }: ReturnOrdersAnalyticsModalProps) {
  const trendData = [
  ...
  const config: AnalyticsModalConfig = {
    title: "Return Orders - Detailed Analytics",
    kpiDefinitionPurpose: {
      sectionTitle: "KPI Definition & Purpose",
      definition:
        "The total count or percentage of orders that were returned within a given period.",
      purpose:
    ...
    tabs: [
      ...
      { id: "ro-product-categories", label: "Product Categories" },
