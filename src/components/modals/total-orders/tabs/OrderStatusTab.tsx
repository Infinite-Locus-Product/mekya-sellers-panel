...
const DEFAULT_ORDER_STATUS_DATA: OrderStatusDataPoint[] = [
  {
    type: "pending",
...
export function OrderStatusTab({ data = DEFAULT_ORDER_STATUS_DATA }: OrderStatusTabProps) {
                ...
                return (
                  <div key={`${item.type}-detail`} className="space-y-2">
                    <div className="flex items-center justify-between text-sm font-medium text-foreground">
                      ...
                      <span>{formatNumber(item.customers)} Orders</span>
                    </div>
